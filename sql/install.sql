INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `toggle_setting_1`, `toggle_setting_2`, `activity`, `subtype`, `edit_options`, `timestamp`) VALUES ('apps', 'react-dev', '../client-app/dev-mode/build/index.html', '100', '1', '0', '', NULL, '', '0', '0', '1', '', '1', '2017-07-23 09:33:02');
...
('apptstat', 'booked',          'Booked',      45, 0, 0, '', 'FFFF2B|0', '', 0, 0, 0, '', 1, '2017-03-09 07:22:18'),
('apptstat', 'arrived',         'Arrived',     80, 0, 0, '', 'C0FF96|0', '', 0, 0, 1, '', 1, '2017-03-09 07:22:18'),
('apptstat', 'cancelled',       'Cancelled',   65, 0, 0, '', 'BFBFBF|0', '', 0, 0, 0, '', 1, '2017-03-09 07:22:18'),
('apptstat', 'noshow',          'No Show',     60, 0, 0, '', 'FFC9F8|0', '', 0, 0, 1, '', 1, '2017-03-09 07:22:18'),
('apptstat', 'waitlist',        'Waitlisted',  15, 0, 0, '', '87FF1F|0', '', 0, 0, 0, '', 1, '2017-03-09 07:22:18');
